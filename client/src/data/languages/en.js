export default {
  ...
  RECOVER_PASSWORD: "Povrati sifru",
  ...
  CREATE_TICKET: "Kontaktirajte gradsku upravu",
  // 'CREATE_TICKET': 'Create Ticket',
  TICKET_LIST: "Ticket List",
  SUPPORT_CENTER: "Support Center",
  SUPERVISED_USER: "Supervised users",
  DEPARTMENT: "Izaberite tip prijave",
  ...
  LEVEL_2_DESCRIPTION:
    "can do every Level 1 does, can create or edit articles and it can create custom responses.",
  LEVEL_3_DESCRIPTION:
    "can do every Level 2 does, can create or edit staff members and can manage the whole system.",
  ...
  MAINTENANCE_MODE_INFO:
    "It will temporary disable the system for regular users.",
  ...
  SUPPORTED_LANGUAGES_INFO:
    "Supported languages are the languages that tickets can be written in.",
  ALLOWED_LANGUAGES: "Allowed Languages",
  ALLOWED_LANGUAGES_INFO:
    "Allowed languages are the languages that can be used by an user.",
  ...
  INSTALL_HEADER_DESCRIPTION:
    "This wizard will help you to configure and install OpenSupports on your website",
  ...
  ADMIN_PASSWORD_DESCRIPTION:
    "Please remember this password. It is needed for accessing the admin panel. You can change it later.",
  INSTALLATION_COMPLETED_TITLE: "Installation completed",
  INSTALLATION_COMPLETED_DESCRIPTION:
    "The installation of OpenSupports is completed. Redirecting to admin panel...",

  STEP_TITLE: "Step {current} of {total} - {title}",
  STEP_1_DESCRIPTION:
    "Select your preferred language for the installation wizard.",
  STEP_2_DESCRIPTION:
    "Here are listed the requirements for running OpenSupports. Please make sure that all requirements are satisfied.",
  ...
  CREATE_TICKET_DESCRIPTION:
    "Ostavite vase podatke i unesite problem, predlog, zamerku. U najkracem mogucem roku cete dobiti odgovor. ",
  // CREATE_TICKET_DESCRIPTION:
  // "This is a form for creating tickets. Fill the form and send us your issues/doubts/suggestions. Our support system will answer it as soon as possible.",
  TICKET_LIST_DESCRIPTION:
    "Here you can find a list of all tickets you have sent to our support team.",
  TICKETS_DESCRIPTION:
    "Send ticket through our support center and get response of your doubts, suggestions and issues.",
  ARTICLES_DESCRIPTION:
    "Take a look to our articles about common issues, guides and documentation.",
  ACCOUNT_DESCRIPTION:
    "All your tickets are stored in your account's profile. Keep track of all your tickets you send to our staff team.",
  SUPPORT_CENTER_DESCRIPTION:
    "Welcome to our support center. You can contact us through a tickets system. Your tickets will be answered by our staff.",
  CUSTOM_RESPONSES_DESCRIPTION:
    "Custom responses are automated responses for common problems",
  CUSTOM_TAGS_DESCRIPTION:
    "Here you can view manage the custom tags for tickets to identify them better",
  MY_TICKETS_DESCRIPTION:
    "Here you can view the tickets you are responsible for.",
  NEW_TICKETS_DESCRIPTION:
    "Here you can view all the new tickets that are not assigned by anyone.",
  ALL_TICKETS_DESCRIPTION:
    "Here you can view the tickets of the departments you are assigned.",
  SEARCH_TICKETS_DESCRIPTION: "Here you can search tickets by specific filters",
  TICKET_VIEW_DESCRIPTION:
    "This ticket has been sent by a customer. Here you can respond or assign the ticket",
  BAN_USERS_DESCRIPTION:
    "Here you can see a list of banned emails, you can un-ban them or add more emails to the list.",
  LIST_USERS_DESCRIPTION:
    "This is the list of users that are registered in this platform. You can search for someone in particular, delete it or ban it.",
  USER_VIEW_DESCRIPTION:
    "Here you can find all the information about an user and all the tickets sent by the user. You can also delete or ban it.",
  DELETE_USER_DESCRIPTION:
    "The user will not be able to log in aging and all its tickets will be erased. Also, the email can not be used any more.",
  DELETE_TOPIC_DESCRIPTION:
    "By deleting the topic, all articles on it will be erased.",
  EDIT_TOPIC_DESCRIPTION:
    "Here you can change the name, the icon and the icon color of the topic.",
  ADD_ARTICLE_DESCRIPTION:
    "Here you can add an article that will be available for every user. It will be added inside the category {category}.",
  LIST_ARTICLES_DESCRIPTION:
    "This is a list of articles that includes information about our services.",
  ADD_TOPIC_DESCRIPTION:
    "Here you can add a topic that works as a category for articles.",
  ...
  DEPARTMENTS_DESCRIPTION:
    "A department is a group where the tickets can go. They are used to categorize the tickets. You can assign them to other staff members.",
  MAINTENANCE_MODE_DESCRIPTION:
    "The support system is in maintenance mode, thus unavailable at the moment. We will come back as soon as possible.",
  EMAIL_TEMPLATES_DESCRIPTION:
    "Here you can edit the templates of the emails that will be sent to users. Remember that the double brackets curly braces indicate a variable value. For example, 'name' represents the user's name.",
  SYSTEM_PREFERENCES_DESCRIPTION:
    "Here you can edit the preferences of the system.",
  VERIFY_SUCCESS_DESCRIPTION:
    "You user has been verified correctly. You can log in now.",
  VERIFY_FAILED_DESCRIPTION: "The verification could not be done.",
  STATISTICS_DESCRIPTION:
    "Here you can view statistics related to tickets and signups.",
  ADVANCED_SETTINGS_DESCRIPTION:
    "Here you can change the advanced settings of your system. Please be careful, the changes you make can not be reversed.",
  ...
  ADD_API_KEY_DESCRIPTION:
    "Insert the name and a registration api key will be generated.",
  SIGN_UP_VIEW_DESCRIPTION:
    "Here you can create an account for our support center. It is required to send tickets and see documentation.",
  EDIT_PROFILE_VIEW_DESCRIPTION: "Here you can edit your user preferences.",
  ENABLE_USER_SYSTEM_DESCRIPTION:
    "Enable/disable the use of an user system. If you disable it, all users will be deleted but the tickets will be kept. If you enable it, the users of existent tickets will be created.",
  CSV_DESCRIPTION:
    "The CSV file must have 3 columns: email, password, name. There is no limit in row count. It will be created one user per row in the file.",
  SMTP_SERVER_DESCRIPTION:
    "The configuration of the SMTP server allows the application to send mails. If you do not configure it, no emails will be sent by OpenSupports.",
  IMAP_SERVER_DESCRIPTION:
    "The configuration of the IMAP server allows the application to create tickets from the emails sent to a mailbox.",
  ENABLE_USER_DESCRIPTION:
    "This action allows the user to sign in and create tickets.",
  DISABLE_USER_DESCRIPTION:
    "User will be disabled and will not be able to sign in and create tickets.",
  PRIVATE_RESPONSE_DESCRIPTION:
    "This response will only be seen by staff members",
  PRIVATE_TOPIC_DESCRIPTION: "This topic will only be seen by staff members",
  PRIVATE_DEPARTMENT_DESCRIPTION:
    "This department will only be seen by staff members",
  LOCK_DEPARTMENT_DESCRIPTION:
    "Allow users to create tickets only in the default department",
  EMAIL_SETTINGS_DESCRIPTION:
    "Here you can edit the settings for receiving and sending email to your customers.",
  IMAP_POLLING_DESCRIPTION:
    "Inbox checking will not be done automatically by OpenSupports. You have to make POST requests periodically to this url to process the emails: {url}",
  NEW_CUSTOM_FIELD_DESCRIPTION:
    "Here you can create a custom field for an user, it can be a blank text box or a fixed set of options.",
  CUSTOM_FIELDS_DESCRIPTION:
    "Custom fields are defined additional fields the users are able to fill to provide more information about them.",
  INVITE_USER_VIEW_DESCRIPTION:
    "Here you can invite an user to join our support system, he will just need to provide his password to create a new user.",
  ...
  ERROR_RETRIEVING_TICKETS:
    "An error occurred while trying to retrieve tickets.",
  ERROR_RETRIEVING_USERS: "An error occurred while trying to retrieve users.",
  ERROR_RETRIEVING_BAN_LIST:
    "An error occurred while trying to retrieve the list of banned emails.",
  ERROR_BANNING_EMAIL: "An error occurred while trying to ban the email.",
  ERROR_RETRIEVING_ARTICLES:
  ...
  DEPARTMENT_PRIVATE_TICKETS:
    "This department has tickets created by non-staff and it can not be private",
  DEFAULT_DEPARTMENT_CAN_NOT_BE_PRIVATE:
    "Default department can not be private",
  ...
  INVITE_USER_SUCCESS:
    "You have invited a new user successfully in our support system",
  ...
  WILL_DELETE_DEPARTMENT:
    "The department will be deleted. All the tickets will be transfer to the department selected.",
  ...
  WILL_DELETE_STAFF:
    "This staff member will be deleted and all its tickets will be unassigned.",
  WILL_RECOVER_EMAIL_TEMPLATE:
    "This email template will be recover to it's default value on this language.",
  ...
  DELETE_CUSTOM_FIELD_SURE:
    "Some users may be using this field. Are you sure you want to delete it?",
  ...
  EMAIL_SERVER_ADDRESS_DESCRIPTION:
    "Address where mails will be received and sent",
  CREATED: "Created",
  ...
  INSTANT: "Instant",
  INSTANT_DESCRIPTION:
    "Percentage of tickets closed after a single staff reply over the total of tickets closed",
  REOPENED: "Reopened",
  REOPENED_DESCRIPTION:
    "Percentage of tickets that were reopened over the total of tickets created",
  MONDAY: "Monday",
  TUESDAY: "Tuesday",
  WEDNESDAY: "Wednesday",
  THURSDAY: "Thursday",
